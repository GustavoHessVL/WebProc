...
const MemAccessComponent: React.FC = () => {
    ...
    const calculateInstruc2 = (P:string, U:string,W:string,L:string,shift:string, tipo:string) =>{
        ...
        if(tipo == '00'){
         shiftString = ', lsl '.concat('#' + parseInt(shift,2))
            ...
            shiftString = ', lsr '.concat('#' + parseInt(shift,2))
        }
        else if(tipo == '10'){
            shiftString = ', asr '.concat('#' + parseInt(shift,2))
        }
        else if(tipo == '11'){
            shiftString = ', ror '.concat('#' + parseInt(shift,2))
        }
        ...
        if(P == '0' && U == '1'){
            result = result.concat('Rd, [Rn], Rm')
            if(shift != '00000'){
                result = result.concat(shiftString)
            }
            return result;
        }
        else if(P == '0' && U == '0'){
    ...
    const calculateExecText2 = (P:string, U:string,W:string,L:string,shift:string, tipo :string) =>{
        ...
        if(P == '0' && U == '1'){
            result = "Pós-indexado com índice positivo, logo escreve/le da memória no valor da base e depois atualiza a base com base + registrador, com deslocamento se for o caso"
            return result;
        }
        else if(P == '0' && U == '0'){
            result = "Pós-indexado com índice negativo, logo escreve/le da memória no valor da base e depois atualiza a base com base - registrador"
            return result;
        }
        else if(P == '1' && U == '1' && W == '0'){
            result = "Pré-indexado com índice positivo, logo escreve/le da memória no valor da base + registrador, com deslocamento se for o caso, sem alterar a base"
            return result;
        }
        else if(P == '1' && U == '0' && W == '0'){
            result = "Pré-indexado com índice negativo, logo escreve/le da memória no valor da base - registrador sem alterar a base"
            return result;
        }
        else if(P == '1' && U == '1' && W == '1'){
            result = "Pré-indexado com índice positivo alterando base, logo escreve/le da memória no valor da base + registrador, alterando a base para esse valor"
            return result;
        }
        else if(P == '1' && U == '0' && W == '1'){
            result = "Pré-indexado com índice negativo alterando base, logo escreve/le da memória no valor da base - registrador, alterando a base para esse valor"
            return result;
        }
    ...
    useEffect(() => {
        ...
        setInstruc2(calculateInstruc2(P2,U2,W2,L2,shift,tipo))
        setExecText2(calculateExecText2(P2,U2,W2,L2,shift,tipo))
      }, [imediato,P1,U1,B1,W1,L1,P2,U2,W2,L2,shift,tipo]);
