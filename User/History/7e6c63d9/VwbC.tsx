...
const MemAccessComponent: React.FC = () => {
    ...
    const calculateExecText2 = (P:string, U:string,W:string,L:string,shift:string, tipo :string) =>{
        ...
        if(P == '0' && U == '1'){
            result = "Pós-indexado com índice positivo, logo escreve/le da memória no valor da base e depois atualiza a base com base + offset"
            return result;
        }
        else if(P == '0' && U == '0'){
            result = "Pós-indexado com índice negativo, logo escreve/le da memória no valor da base e depois atualiza a base com base - offset"
            return result;
        }
        else if(P == '1' && U == '1' && W == '0'){
