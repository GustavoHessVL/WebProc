...
const MemAccessComponent: React.FC = () => {
    ...
    const calculateExecText1 = (P:string, U:string,W:string,L:string,imediato:string) =>{
        ...
        if(P == '0' && U == '1'){
            ...
            result = "Pré-indexado com índice positivo alterando base, logo escreve/le da memória no valor da base + offset, alterando a base para esse valor"
            return result;
        }
        else if(P == '1' && U == '0' && W == '1'){
            result = "Pré-indexado com índice negativo alterando base, logo escreve/le da memória no valor da base - offset, alterando a base para esse valor"
            return result;
        }
