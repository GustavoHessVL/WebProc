...
const MemAccessComponent: React.FC = () => {
    ...
    const calculateExecText1 = (P:string, U:string,W:string,L:string,imediato:string) =>{
        ...
        if(P == '0' && U == '1'){
            ...
            result = "Pré-indexado com índice positivo, logo escreve/le da memória no valor da base + offset sem alterar a base"
            return result;
        }
        else if(P == '1' && U == '0' && W == '0'){
            result = "Pré-indexado com índice negativo, logo escreve/le da memória no valor da base - offset sem alterar a base"
            return result;
        }
        else if(P == '1' && U == '1' && W == '1'){
