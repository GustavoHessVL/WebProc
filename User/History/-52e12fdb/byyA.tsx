    ...
    switch(condKey){
      ...
      case '1000':
        ...
        if(cpsrState[1] == 0 && cpsrState[2] == 1){
          return "Executa instrução! Carry flag ativa indica que o número comparado é maior! Zero flag inativa garante que o número comparado não é igual! ";
        }
        return "Não executa instrução!";
      case '1001':
        // PRECISA JUSTIFICAR!!!!!!!!!!!!!! -> Justificado
      ...
      case '1011':
        if(cpsrState[0] == 0 && cpsrState[3] == 1){
          ...
          return "Executa instrução! Negativo inativo e com Overflow! Nota-se por exemplo em uma subtração de dois negativos resultando em um positivo (a - b = não negativo -> a >= b )! "
        }
