    ...
    switch(condKey){
      ...
      case '1100':
        ...
        if(cpsrState[0] == 1 && cpsrState[1] == 0 && cpsrState[3] == 1){
          ...
          return "Executa Instrução! Overflow e Negativo Flag ambos em alta e Zero Flag inativa. Nota-se que isso ocorreria, por exemplo, na subtração de dois números negativos resultando em um positivo [a, b > 0]( a - b = positivo -> a > b)";
        }
        return "Não executa instrução!"
      case '1101':
        if (cpsrState[1] == 1) {
