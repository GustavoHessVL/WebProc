    ...
    switch(condKey){
      ...
      case '1011':
        if(cpsrState[0] == 0 && cpsrState[3] == 1){
          ...
          // NECESSITA DE JUSTIFICATIVA
          return "Executa instrução! Negativo ativo e Overflow invativo! Ocorre, por exemplo, na subtração de dois números negativos quando um é, em modulo, maior que o outro, resultando em um negativo!"
        }
        return "Não executa instrução! ";
      case '1100':
