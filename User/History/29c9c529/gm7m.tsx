...
const AritComponent: React.FC = () => {
    ...
    const calculateExecutionText2 = (rotacao:string, imediato:string) =>{
        ...
        if(imediato != 'xxxxxxxx' && rotacao != 'xxxx'){
            result = result.concat('O Imediato de 8 bits (' + imediato + ') é posicionado em uma palavra de 32 bits de acordo com a rotacao, nesse caso, desloca-se o valor em: '  + parseInt(rotacao + '0',2))
        }
        return result;
    }
