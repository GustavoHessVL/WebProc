...
const Theory41 = "As instruçãos de salto são aquelas que alteram o PC(R15), alterando o gluxo de execução do programa. Um dos modos de realizar um salto é utilizando uma instrução de branch, seja ela branch(b) ou branch and link(bl) salvando o PC atual no registrador R14.";
