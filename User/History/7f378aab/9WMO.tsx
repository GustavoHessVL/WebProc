      ...
      <div className="ContentDiv">
        ...
        <div className="Theory">
          <div style = {{
              ...
              textAlign: 'justify',   // Centralizar o texto dentro do elemento
              padding: '10px',       // Adicionar espaço em volta do texto
              margin: '10px',        // Adicionar espaço externo ao redor do elemento
            }}>
          {Theory21}
          </div>
          <div style = {{
